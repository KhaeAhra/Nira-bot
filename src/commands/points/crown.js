...
module.exports = class CrownCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['crowned'],
      usage: 'crown',
      description: 'Affiche tous les membres de la guilde couronnés, le rôle Crown et le calendrier Crown.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      ...
      .addField('Crown Rôle', crownRole)
      .addField('Crown Programme', `\`${crownSchedule || 'None'}\``)
