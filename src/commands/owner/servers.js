...
module.exports = class ServersCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['servs'],
      usage: 'servers',
      description: 'Affiche une liste des serveurs joints de Nira.',
  ...
  run(message) {
    ...
    if (servers.length <= 10) {
      ...
      message.channel.send(embed.setTitle(`Serveurs Liste ${range}`).setDescription(servers.join('\n')));
    } else {
