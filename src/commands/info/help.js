...
module.exports = class HelpCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
      Affiche une liste de toutes les commandes en cours, triées par catégorie.
      Peut être utilisé en conjonction avec une commande pour des informations supplémentaires.
      N'affichera que les commandes auxquelles vous êtes autorisé à accéder, sauf si le paramètre \`all\` est donné. 
      `,
  ...
  run(message, args) {
    ...
    if (
      ...
      return this.sendErrorMessage(message, 0, 'Impossible de trouver la commande, veuillez vérifier la commande fourni');
