...
module.exports = class ServerStaffCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['staff'],
      usage: 'serverstaff',
      description: 'Affiche une liste de tous les modérateurs et administrateurs de serveur actuels.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle(`Liste du Staff [${modList.length + adminList.length}]`)
      .setThumbnail(message.guild.iconURL({ dynamic: true }))
      .addField(`Admins [${adminList.length}]`, admins, true)
      .addField(`Modos [${modList.length}]`, mods, true)
