...
module.exports = class AliasesCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
      Affiche une liste de tous les alias actuels pour le type de commande donné.
      Si aucun type de commande n'est donné, le nombre d'alias pour chaque type sera affiché. 
      `,
  ...
  run(message, args) {
    ...
    if (args[0] && types.includes(type) && (type != OWNER || message.client.isOwner(message.member))) {
      ...
      embed.addField( 
        'Links',
        '**[Invité moi](https://discord.com/api/oauth2/authorize?client_id=860511373711638539&permissions=8&scope=bot) | '
      );
