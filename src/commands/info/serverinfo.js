...
module.exports = class ServerInfoCommand extends Command {
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      ...
      .addField('Notifications par défault', notifications[message.guild.defaultMessageNotifications], true)
      .addField('Partnaire', `\`${message.guild.partnered}\``, true)
      .addField('Verifié', `\`${message.guild.verified}\``, true)
      .addField('Crée le', `\`${moment(message.guild.createdAt).format('MMM DD YYYY')}\``, true)
      .addField('Serveur stats', `\`\`\`asciidoc\n${serverStats}\`\`\``)
