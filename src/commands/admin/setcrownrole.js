...
module.exports = class SetCrownRoleCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
      Définit le rôle que Nira donnera au membre avec le plus de points à chaque cycle.`,
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(`Le \`rôle de la couronne\` a été mis à jour avec succès.  ${emojis.success}`)
