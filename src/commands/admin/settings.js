...
module.exports = class SettingsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
      Affiche une liste de tous les paramètres actuels pour la catégorie de paramètres donnée.
      Si aucune catégorie n'est donnée, le nombre de paramètres pour chaque catégorie sera affiché
      `,
