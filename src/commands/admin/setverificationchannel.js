...
module.exports = class SetVerificationChannelCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
      Définit le canal de texte de vérification pour votre serveur. Si défini, les membres non vérifiés commenceront ici.
  ...
  async run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(`Le \`canal de vérification\` a été mis à jour avec succès.  ${emojis.success}`)
