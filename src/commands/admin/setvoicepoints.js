...
module.exports = class SetVoicePointsVoice extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Définit le nombre de points gagnés par minute passée dans le chat vocal .',
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(`La valeur \`points vocaux\` a été mise à jour avec succès.  ${emojis.success}`)
