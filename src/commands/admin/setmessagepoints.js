...
module.exports = class SetMessagePointsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Définit le nombre de points gagnés par message des utilisateur.',
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(`La valeur des \`points de message\` a été mise à jour avec succès.  ${emojis.success}`)
