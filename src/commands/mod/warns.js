...
module.exports = class WarnsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: `Affiche les avertissements actuels d'un membre. Un maximum de 5 avertissements peuvent être affichés en même temps.`,
  ...
  run(message, args) {
    ...
    const buildEmbed = (current, embed) => {
      ...
      return embed
        ...
        .setDescription(`L'affichage du \`${amount}\` du total de ${member} \`${count}\` met en garde`);
    };
