module.exports = async (client) => {
  ...
  const activities = [
    { name: '@Nira | V2.0.0', type: 'LISTENING' }, 
    { name: 'use n!help', type: 'LISTENING' }
  ];
  ...
  setInterval(() => {
    ...
    activities[3] = { name: `${client.users.cache.size} utilisateurs`, type: 'WATCHING' }; 
  ...
  client.logger.info(`${client.user.tag} en Ligne`);
  client.logger.info(`Connecté sur ${client.guilds.cache.size} serveur(s), pour un total de ${client.users.cache.size} utilisateurs`);
};
